...
const driverLogin = ({ route, navigation }) => {
    ...
    function login() {
        signInWithEmailAndPassword(auth, data.email, data.password)
            .then(userCredential => {
                ...
                console.log(user)
                navigation.navigate('drivermainscreen')
            }, null)
            .catch(error => {
                console.log(error)
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View style={styles.button}>
                    <TouchableOpacity
                        style={styles.signIn}
                        disabled={data.isValidUser == false}
                        //style={data.isValidUser == false ? styles.signIn : styles.signInn}
                        onPress={login}
                    >
                        <LinearGradient
                            colors={['black', 'black']}
